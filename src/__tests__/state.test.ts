...
function fromStorage(data: Partial<StorageState>, tabId: number | null): RefreshStatus {
...
function isTabActive(data: Partial<StorageState>, tabId: number): boolean {
	return data.active === true && data.currentTabId === tabId;
}

function isTabPaused(data: Partial<StorageState>, tabId: number): boolean {
