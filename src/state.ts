...
export function fromStorage(data: Partial<StorageState>, tabId: number | null): RefreshStatus {
...
export function isTabActive(data: Partial<StorageState>, tabId: number): boolean {
	return data.active === true && data.currentTabId === tabId;
}

export function isTabPaused(data: Partial<StorageState>, tabId: number): boolean {
